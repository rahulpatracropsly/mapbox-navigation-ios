Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://github.com/rahulpatracropsly/mapbox-navigation-ios.git", :tag => "v#{s.version.to_s}" }
  ...
  s.dependency "MapboxMobileEvents", "~> 0.10.4" # Always specify a patch release if pre-v1.0
